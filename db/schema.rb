...
ActiveRecord::Schema.define(version: 2018_06_20_144248) do
  ...
  create_table "contexts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ancestry"], name: "index_contexts_on_ancestry"
  end
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["context_id"], name: "index_templates_on_context_id"
